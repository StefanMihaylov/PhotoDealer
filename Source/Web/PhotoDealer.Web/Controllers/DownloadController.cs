namespace PhotoDealer.Web.Controllers
{
    ...
    public class DownloadController : BaseController
    {
        ...
        public ActionResult Download(string pictureId, PictureSizeEnum? pictureSize)
        {
            ...
            var picture = this.GetPictureFromDb(pictureId);
            ...
            if (user.Credits < price)
            {
                ...
                return this.RedirectToDetails(pictureId);
            }
            ...
            return this.DownloadPictureContent(picture, width);
        }

        public ActionResult AuthorDownload(string id)
        {
            var picture = this.GetPictureFromDb(id);

            if (this.IsOwner(picture.AuthorId))
            {
                return this.DownloadOriginalPicture(picture);
            }
            else
            {
        ...
        public ActionResult Delete(string id)
        {
            ...
            if (this.IsOwner(picture.OwnerId))
            {
